  ...
  hotels: [
    {
      name: "盛美利亚", rec: "⭐⭐⭐⭐⭐",
      meta: ["档次 ⭐⭐⭐⭐⭐", "价格 $$$$", "LED ✅", "停车 ⭐⭐⭐⭐"],
      price: "宴席 ¥6200/桌起（约20桌）· 包房 ¥800–850/间带休息厅 · 整体预算约 1.5 万（待确认）",
      keys: ["锦城湖附近，独立宴会厅 + 户外区 + 酒吧，私密性好",
             "两厅各容纳约 300 人，层高 4.5m，可迎宾/签到，动线顺畅",
             "赠饮料约 4 瓶、甜品约 100 份、矿泉水；迎宾茶歇约 ¥30/人（待确认）"],
      pros: ["仪式感最好", "动线最佳", "LED/投影齐全", "迎宾区宽敞"],
      cons: ["价格相对较高"],
    },
    {
