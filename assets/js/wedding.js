  ...
  hotels: [
    ...
    },
    {
      ...
      secs: [
        ...
        { h: "🏛️ 厅2｜宴会厅（约 200㎡）", items: ["较细长，容纳 8–10 桌；有 LED、无舞台", "有景观窗但夜晚看不到双子塔；灯光吊顶偏会议厅风格"] },
        { h: "🏛️ 厅3｜大厅（约 1000㎡）", items: ["容纳 20+ 桌，不分隔，可搭建舞台", "化妆间/茶水间捆绑大厅使用，若售出则无法使用"] },
        { h: "🚪 序厅", items: ["本楼层公共过道较窄；背景墙、甜品台、签到区布置局促"] },
        { h: "🅿️ 停车", items: ["与 in99 共用，车位充足，宴会免费；车场太大不易找位"] },
      ],
      pros: ["酒店档次最高", "品牌最好", "扇形厅拥有双子塔夜景", "餐标较盛美利亚便宜约 ¥400/桌", "停车免费"],
      cons: ["客房最贵（约 ¥1500+/晚）", "扇形厅仅适合 4 桌", "厅1 无 LED/投影", "厅2 无舞台", "序厅空间较小", "化妆间、茶水间受大厅档期限制", "停车场太大，不易找车位"],
    },
    {
